...
//a method to check the correct player number is selected
   public numPlayer(int playerNum) {
...
// Boolean active - if a player is still in the game or not ?not sure if this is needed
boolean active = true;
        if (active) {
...
// removeCard? - remove top card from the hand and shift array to fill gap at 0
